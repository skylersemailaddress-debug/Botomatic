...
export type UISourcePatchOperationWithIdentity = UISourcePatchOperation & UISourcePatchIdentityMetadata;
export type UISourcePatch = { operations: UISourcePatchOperationWithIdentity[]; changedFiles: string[]; caveat: string };
...
export function createUISourcePatchFromSyncPlan(plan: UISourceSyncPlan, mapping: UISourceFileMapping): UISourcePatch {
  const operations: UISourcePatchOperationWithIdentity[] = [];
