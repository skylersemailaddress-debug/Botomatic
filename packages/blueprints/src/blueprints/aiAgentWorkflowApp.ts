...
export const aiAgentWorkflowApp: Blueprint = {
  id: "ai_agent_workflow_app",
  name: "aiAgentWorkflowApp",
  category: "ai",
  description: "Commercial aiAgentWorkflowApp blueprint with production defaults and no-placeholder policy.",
