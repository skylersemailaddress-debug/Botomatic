...
export const contentMediaSite: Blueprint = {
  id: "content_media_site",
  name: "contentMediaSite",
  category: "media",
  description: "Commercial contentMediaSite blueprint with production defaults and no-placeholder policy.",
