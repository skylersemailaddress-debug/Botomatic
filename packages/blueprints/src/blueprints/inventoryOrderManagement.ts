...
export const inventoryOrderManagement: Blueprint = {
  id: "inventory_order_management",
  name: "inventoryOrderManagement",
  category: "operations",
  description: "Commercial inventoryOrderManagement blueprint with production defaults and no-placeholder policy.",
