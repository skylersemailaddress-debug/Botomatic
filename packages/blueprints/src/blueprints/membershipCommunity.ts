...
export const membershipCommunity: Blueprint = {
  id: "membership_community",
  name: "membershipCommunity",
  category: "community",
  description: "Commercial membershipCommunity blueprint with production defaults and no-placeholder policy.",
