...
export const internalAdminTool: Blueprint = {
  id: "internal_admin_tool",
  name: "internalAdminTool",
  category: "internal",
  description: "Commercial internalAdminTool blueprint with production defaults and no-placeholder policy.",
