...
export const nonprofitVolunteerOps: Blueprint = {
  id: "nonprofit_volunteer_ops",
  name: "nonprofitVolunteerOps",
  category: "nonprofit",
  description: "Commercial nonprofitVolunteerOps blueprint with production defaults and no-placeholder policy.",
