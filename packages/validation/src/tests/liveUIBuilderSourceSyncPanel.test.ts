...
assert(panel.includes("Scalability plan id:"));
assert(panel.includes("Scalability document node count:"));
assert(panel.includes("Scalability source file count:"));
assert(panel.includes("Scalability total source bytes:"));
assert(panel.includes("Scalability operation count:"));
assert(panel.includes("Scalability generated file count:"));
assert(panel.includes("Scalability identity count:"));
assert(panel.includes("Scalability dependency count:"));
assert(panel.includes("Scalability risk level:"));
assert(panel.includes("Scalability manual review required:"));
assert(panel.includes("Scalability chunk count:"));
assert(panel.includes("Scalability index recommendation count:"));
assert(panel.includes("Scalability pagination recommendation count:"));
assert(panel.includes("Scalability blocked reason count:"));
assert(panel.includes("Scalability/performance planning is dry-run only and does not execute benchmarks, write files, deploy, or prove runtime performance."));
